      ...
      <div className="flex flex-1 flex-col bg-[#F8F9FA] p-[24px] md:p-[34px]">
        ...
        <div className="flex flex-wrap gap-[6px] pt-[21px] pb-[16px] border-b border-[#E4E4E7]">
          <Link
            ...
            className="inline-flex items-center rounded-full border border-primary-light bg-[#D8ECF5] py-[6px] px-[18px] text-[10px] md:text-[12px] font-medium uppercase leading-none text-[#2E4259] transition-colors duration-300 hover:bg-[#c7e4f1]"
          >
        ...
        <div className="mt-auto pt-[16px] pr-[8px]">
          <div className="flex items-end w-full justify-between gap-[10px]">
            <div className="space-y-[8px] w-full">
              <div className="flex items-center gap-[8px] text-[16px] md:text-[18px] font-outfit leading-none text-[#6C757E]">
              ...
              <div className="flex items-center justify-between gap-[8px] text-[16px] md:text-[18px] font-outfit leading-none text-[#6C757E]">
