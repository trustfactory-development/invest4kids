      ...
      <div className="mx-auto w-full max-w-[1100px]">
        <div className="flex flex-col items-center gap-0 md:gap-[30px] lg:flex-row lg:justify-between lg:gap-[30px]">
          <div className="flex w-full flex-col items-center lg:w-[468px] lg:items-start">
            ...
            <p className="mb-[34px] max-w-[536px] text-center font-outfit text-[16px] leading-[126%] font-light text-[#4B5563] md:text-left md:text-[18px] md:leading-[23px]">
              Wenn du gerade überlegst, wie du die Zukunft deines Kindes absichern kannst, sind wir
              für dich da – mit einem kostenlosen, unverbindlichen Gespräch. Verständlich erklärt.
              Ohne Verkaufsdruck. Aber mit einem echten Plan.
            </p>
            ...
            <a
              ...
              className="inline-flex w-full max-w-full items-center justify-center gap-1.5 rounded-[50px] border border-primary bg-primary px-9 py-[15px] font-outfit text-[16px] leading-none font-medium text-white transition-colors duration-200 hover:border-accent hover:bg-accent hover:text-text-medium md:w-auto md:self-start md:text-[18px]"
            >
              <svg
                ...
                aria-hidden="true"
              >
                <path d={calendarIconPath} />
              </svg>
              <span>Kostenlos beraten lassen</span>
            </a>
          </div>

          <div className="mt-8 flex w-full justify-center md:mt-8 lg:mt-0 lg:w-[538px] lg:items-center">
            <Image
              src="https://invest4kids.de/wp-content/uploads/2025/11/Group-Photo-e1763991614223-1024x788.webp"
              alt="Invest4Kids Team - Experten für Kinderinvestments und Finanzwissen"
              width={1024}
              height={788}
              className="h-auto w-full max-w-[538px] md:max-w-[680px] lg:max-w-[538px]"
            />
          </div>
        </div>
      </div>
